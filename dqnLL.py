# DQN implementation for Lunar Lander with experience replay and target network
...
class DQNAgent:
    def __init__(self, env, gamma=0.99, alpha=0.00025, epsilon=0.1, epsilon_decay=0.995, min_epsilon=0.01, beta=0.4, target_update_freq=1000, buffer_size=100000, batch_size=64):
        self.env = env
        self.gamma = gamma
        ...
        self.q_network = DQNLL(self.state_dim, self.action_dim)
        ...
        self.target_network = DQNLL(self.state_dim, self.action_dim)
